...
.overlay {
	background: #020202;
	background: linear-gradient(to right, #000000, #292723);
	background: linear-gradient(to right, #373645, #51505e);
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="signup.php" method="post">
			...
			<input type="text" placeholder="Name" name="naav" required/>
     ...
     <input id="confirm_pass"
			...
			<input type="submit" name="signup" id="button" onclick="wrong_pass_alert()">
		</form>
	</div>
